...
- **On-page modules** in the main column use rough shapes that match the module type: offer cards, logo boxes, work cards with image placeholders, quote blocks, 16:9 video, metric boxes, report cards, article text blocks, empty states, pagination, forms. Related-theme tags that would appear on the live page stay in the body as page tags, not as working notes.
