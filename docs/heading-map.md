...
- **Alts:**
  ...
  - growth strategy (~480) caught on the lead service page, not here
- **H1:** Our Growth Architecture
- **H2s (ordered):**
  1. Three ways we work with you
...
- **Alts:**
  ...
  - go to market strategy (~880) where true to the offer
- **H1:** Growth Strategy
- **H2s (ordered):**
  1. Why this, now
  2. What we do
  ...
  5. Demand signals
  6. Scenario planning
  7. Customer, Innovation, Value and Delivery
  8. Proof
  9. How it works
- **H3s:**
  - Customer
...
- **Alts:**
  ...
  - brand proposition (~90)
- **H1:** Proposition Innovation
- **H2s (ordered):**
  1. Why this, now
  2. Value proposition design
  3. Loyalty propositions
  4. Membership propositions
  5. Subscription propositions
...
- **Alts:**
  ...
  - interim CMO / interim growth team (~110 to 140) in the Growth Office line
...
- **Alts:**
  ...
  - customer research agency (~20)
- **H1:** Customer Research and Insight
- **H2s (ordered):**
  1. Why this, now
  2. Customer research methods
  3. Customer journey mapping
  4. Research projects
  5. Always-on customer insight
  6. Proof
  7. How it works
- **H3s:**
  - Digital listening
...
- **Alts:**
  - customer journey mapping (~2,900)
  - cx consultancy (~70)
  - website design consultancy (~70)
  - experience design agency (~110)
...
- **H2s (ordered):**
  ...
  4. Test
  5. Scale
  6. Customer experience (CX) design
  7. Website and digital product
...
- **Alts:**
  ...
  - do not use bare ai agents (~9,900) as the sole target
...
- **Alts:**
  ...
  - operating model consultancy (~10)
- **H1:** Operating Model Design
- **H2s (ordered):**
  1. Why this, now
  2. Target operating model
  3. Adaptive operating model
  4. Our Operating Architecture framework
  5. Proof
  6. How it works
- **H3s:**
...
- **Alts:**
  ...
  - interim activation then embed (deck shape)
- **H1:** Growth Office
- **H2s (ordered):**
  1. Why this, now
  2. Interim growth team
  3. Then embed
  4. Culture
  5. Capability
  6. Value
...
- **Alts:**
  ...
  - where AI pays off (value cases, plain language)
- **H1:** AI Enablement
- **H2s (ordered):**
  1. Why this, now
  2. AI skills and adoption
  3. Finding where AI pays off
...
- **Alts:**
  ...
  - related service terms live on Proposition Innovation and Customer Research
- **H1:** Loyalty
- **H2s (ordered):**
  1. Our view
  2. Where we help
...
- **H2s (ordered):**
  ...
  2. Actions: button versus link versus filter versus tag
  3. Cards (one shape per type)
  4. Proof and media
  5. Page blocks
  6. Forms
  7. Empty state and pagination
  8. Cookie bar
