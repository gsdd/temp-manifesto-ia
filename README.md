...
| `docs/ia-recommendations-report.md` | Client-facing IA recommendations report: hierarchy, sitemap, mega-nav, templates and components, search language, evidence, open decisions | Client review |
